      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-500">
            View your past plant scans and analysis results
          </p>
        </div>
        ...
        {isLoading ? (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/50 to-transparent">
                    <span
                      className={`inline-block px-2 py-1 rounded text-xs font-semibold backdrop-blur-sm ${
                        scan.severity === "high"
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  {scan.notes && (
                    <p className="text-sm text-gray-600 italic bg-gray-50 p-2 rounded mb-4 line-clamp-2">
                      {scan.notes}
                    </p>
                  )}
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      <button
                        className="px-3 py-2 bg-secondary/10 text-secondary rounded-lg hover:bg-secondary/20 transition-colors text-sm font-medium cursor-pointer"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <button
                        className="px-3 py-2 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium cursor-pointer"
                        onClick={(e) => {
                          e.stopPropagation();
                          openEditModal(scan);
                        }}
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl shadow-sm border border-gray-100 text-center">
            ...
            <Link
              to="/dashboard"
              className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors font-medium cursor-pointer shadow-sm"
            >
              Scan a Plant
            </Link>
          </div>
        ...
        {isModalOpen && selectedScan && (
          ...
          >
            <div
              className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up"
            ...
            >
              ...
              <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-xl flex justify-between items-center">
                ...
                <div className="flex gap-3">
                  <button
                    className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors font-medium cursor-pointer"
                    onClick={closeScanDetails}
                  >
                    Close
                  </button>
              ...
              <div className="p-6">
                <form onSubmit={handleEditSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end gap-3 pt-2">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary-dark transition-colors cursor-pointer shadow-sm"
                    >
                      Save Changes
                    </button>
                  </div>
